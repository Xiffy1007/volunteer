package com.xiffy.util;

import com.xiffy.constant.SystemConstant;
import com.xiffy.entity.CheckResult;
...
public class JwtUtils {
     ...
     * @return
     */
    public static String createJWT(String id, String subject, long ttlMillis) {//创建token
     ...
     * @return
     */
    public static CheckResult validateJWT(String jwtStr) {//验证token
